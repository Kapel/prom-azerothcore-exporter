...
func (e *Exporter) Collect(ch chan<- prometheus.Metric) {
	...
	metrics.AuctionActiveCount.Collect(ch)
	metrics.AuctionActiveValueGold.Collect(ch)
	metrics.AuctionAvgBuyoutGold.Collect(ch)
	metrics.AuctionBidActivity.Collect(ch)
	metrics.AuctionTopSales.Collect(ch)
...
func (e *Exporter) Describe(ch chan<- *prometheus.Desc) {
	...
	metrics.AuctionActiveCount.Describe(ch)
	metrics.AuctionActiveValueGold.Describe(ch)
	metrics.AuctionAvgBuyoutGold.Describe(ch)
	metrics.AuctionBidActivity.Describe(ch)
	metrics.AuctionTopSales.Describe(ch)
